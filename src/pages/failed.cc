...
void Game_Failed::update_page(Route *route, real_t dt, utick_t)
{
...
void Game_Failed::render_page(Route *route, const Render_Context &rc)
{
  ...
  auto title      = mgr->query_text_texture("Devastated!", "res/opensans.ttf", 32, c, c, c);
...
Game_Failed::Game_Failed(const Game_Failed &)
{ Li_PanicF("DO NOT CALL Game_Failed's COPY-CONSTRUCTOR!"); }

void Game_Failed::do_update(const Update_Ctx &)
{ }
